...
class NoManualSalesChannelContextCreationRule implements Rule
{
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        return [
            RuleErrorBuilder::message('Manual creation of `HeyFrame\Core\System\SalesChannel\SalesChannelContext` is not allowed.')
                ->identifier('heyframe.noManualSalesChannelContextCreation')
                ->addTip('Use `HeyFrame\Core\System\SalesChannel\Context\SalesChannelContextFactory` or `HeyFrame\Core\Test\Generator::generateSalesChannelContext` instead.')
                ->build(),
        ];
    }
