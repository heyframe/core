...
class Migration1649858046UpdateConfigurableFormatAndValidationForAddressCountry extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        $connection->executeStatement('
            ALTER TABLE `country`
            ADD COLUMN `postal_code_required` TINYINT (1) NOT NULL DEFAULT 0 AFTER `iso3`,
            ADD COLUMN `default_postal_code_pattern` VARCHAR (1024) NULL AFTER `iso3`,
            ADD COLUMN `check_postal_code_pattern` TINYINT (1) NOT NULL DEFAULT 0 AFTER `iso3`,
            ADD COLUMN `check_advanced_postal_code_pattern` TINYINT (1) NOT NULL DEFAULT 0 AFTER `iso3`,
            ADD COLUMN `advanced_postal_code_pattern` VARCHAR (255) NULL AFTER `iso3`;
        ');
