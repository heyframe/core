...
class ApiAuthenticationListener implements EventSubscriberInterface
{
    ...
    public function setupOAuth(RequestEvent $event): void
    {
        ...
        $heyframeGrant = new HeyFrameGrantType($this->refreshTokenRepository, $this->userService, $this->tokenService);
        $heyframeGrant->setRefreshTokenTTL($refreshTokenInterval);
        ...
        $this->authorizationServer->enableGrantType($heyframeGrant, $accessTokenInterval);
    }
