...
class ApiException extends HttpException
{
    ...
    public static function invalidSalesChannelId(string $salesChannelId): HeyFrameHttpException
    {
    ...
    public static function salesChannelNotFound(): HeyFrameHttpException
    {
