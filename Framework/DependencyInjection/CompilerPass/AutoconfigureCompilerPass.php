...
use HeyFrame\Core\Content\Product\SalesChannel\Listing\Filter\AbstractListingFilterHandler;
use HeyFrame\Core\Content\Product\SalesChannel\Listing\Processor\AbstractListingProcessor;
...
class AutoconfigureCompilerPass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container): void
    {
        ...
        $container
            ...
            ->addTag('heyframe.sales_channel.entity.definition');
