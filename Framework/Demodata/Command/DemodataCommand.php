...
namespace HeyFrame\Core\Framework\Demodata\Command;
...
use HeyFrame\Core\Framework\Demodata\Event\DemodataRequestCreatedEvent;
    ...
    private function ensureAllDependenciesArePresent(): void
    {
        ...
        foreach ($classes as $class) {
            if (!class_exists($class)) {
                throw new \RuntimeException('Please install composer package "heyframe/dev-tools" to use the demo-data command.');
            }
        }
    }
}
