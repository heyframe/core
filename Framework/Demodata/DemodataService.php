...
use HeyFrame\Core\Framework\Demodata\Faker\Commerce;
...
{
    public const DEMODATA_CUSTOM_FIELDS_KEY = 'heyframeDemoData';
    ...
    {
        if (!$console) {
            $console = new HeyFrameStyle(new ArgvInput(), new NullOutput());
        }
